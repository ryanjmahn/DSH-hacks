...
const FooterSection = () => {
  ...
  return (
    <footer className="bg-brand-deep text-paper py-16 sm:py-20">
      <div className="mx-auto w-full max-w-7xl px-6 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          <motion.div {...leftMotion} className="flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="mb-4 flex items-center gap-3">
              ...
              <span className="type-title text-paper !text-2xl">DSH Hacks</span>
            </div>
            <p className="type-body text-paper/60 !text-sm mb-1">DeltaForge Hacks × NXT Horizon × STEMise</p>
            <p className="type-body text-paper/80 !text-sm mb-6">
              <a href="https://dsh-hacks-v2.devpost.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white underline underline-offset-4 decoration-paper/30 hover:decoration-white transition-colors">
                dsh-hacks-v2.devpost.com
              </a>
            </p>
            <div className="flex gap-5 text-paper/80">
          ...
          <motion.div {...rightMotion} className="grid grid-cols-2 gap-8 text-center lg:text-left">
            <div>
              <h3 className="type-meta text-paper mb-4">Hackathon</h3>
              <ul className="space-y-2.5 type-body !text-sm text-paper/70">
            ...
            <div>
              <h3 className="type-meta text-paper mb-4">Community</h3>
              <ul className="space-y-2.5 type-body !text-sm text-paper/70">
        ...
        <div className="mt-12 pt-6 border-t border-paper/20 text-center type-meta !text-xs text-paper/50">
