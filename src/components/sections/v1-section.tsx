...
import { SectionHeading, StatNumeral, Numeral, useFadeRise } from "@/components/sections/design-system";
...
const V1Section = () => {
  ...
  return (
    <section id="v1" className="relative bg-paper-alt text-ink py-24 sm:py-32">
      <div className="mx-auto w-full max-w-7xl px-6 sm:px-8">
        ...
        <motion.p {...winnersLabelMotion} className="type-meta text-ink-muted mt-16 sm:mt-20">
        ...
        <motion.div {...ctaMotion} className="mt-14 flex flex-col sm:flex-row gap-4">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-ink text-ink px-8 py-3.5 type-meta hover:border-brand hover:text-brand transition-colors"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 text-ink-muted px-8 py-3.5 type-meta underline underline-offset-4 decoration-rule hover:text-brand hover:decoration-brand transition-colors"
          >
            V1 on Devpost
            <ExternalLink className="w-3.5 h-3.5" />
          </a>
