...
const WorkshopsSection = () => {
  ...
  return (
    <section id="workshops" className="relative overflow-hidden bg-paper py-24 text-paper sm:py-32">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 sm:px-8">
        ...
        <motion.p {...introMotion} className="type-body mt-8 max-w-2xl leading-relaxed text-paper-dim">
          ...
          <a
            ...
            className="text-rubric-light underline decoration-rule-dark underline-offset-4 transition-colors hover:text-paper"
          >
            ...
            >
              {visible.map((video) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col border border-rule transition-colors hover:border-paper"
                >
                  <div className="relative aspect-video overflow-hidden border-b border-rule">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-ink/10 transition-colors group-hover:bg-ink/25">
                      <div className="flex h-12 w-12 items-center justify-center bg-paper">
                        <Play className="ml-0.5 h-5 w-5 text-paper" fill="currentColor" />
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-1 flex-col p-5">
                    <p className="type-title !text-lg leading-snug text-paper">{video.topic}</p>
                    <p className="type-eyebrow mt-2 text-paper-dim">{video.speaker}</p>
                  </div>
                </a>
              ))}
            </motion.div>
